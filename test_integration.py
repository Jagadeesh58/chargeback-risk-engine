...
from hidden_truth import generate_one
import random

from scorer import predict_win_probability
from evidence import assemble
from policy import decide
from audit_log import DB_PATH, get_existing_decision
from api import app
...
def test_full_pipeline_from_generated_data_through_api_to_audit_log():
    ...
    expected_probability = predict_win_probability(dispute_dict)
...
def test_full_pipeline_over_ceiling_generated_dispute_never_auto_contests():
    ...
    hand-picked dict."""
    from policy import MONETARY_CEILING
